...
Figure \ref{fig:dlplots} suggests that the \CRANpkg{AlgDesign} followed by \CRANpkg{agricolae} are far more downloaded than any other DoE packages. It is worth noting that \CRANpkg{agricolae} imports \CRANpkg{AlgDesign} thus any download of \CRANpkg{agricolae} likely results also in a download of \CRANpkg{AlgDesign}. 
